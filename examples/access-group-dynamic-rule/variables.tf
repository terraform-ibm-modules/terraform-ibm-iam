...
variable "name" {
    description = "Enter the name of the dynamic rule for the IAM access group."
    type        = string
}

variable "expiration" {
  type        = number
  description = "Enter Number of hours that authenticated users can work in IBM Cloud before they must refresh their access."
}
